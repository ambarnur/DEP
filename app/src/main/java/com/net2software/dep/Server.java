...
public class Server {
    public static  final String URL = "http://10.100.10.108/api/login";
    public static  final String URL_REGISTER = "http://10.100.10.108/api/register";
    public static  final String URL_TEMPAT = "http://10.100.10.108/api/tempat";
    public static  final String URL_LAPANGAN = "http://10.100.10.108/api/lapangan";
    public static  final String URL_JADWAL = "http://10.100.10.108/api/jadwal";
